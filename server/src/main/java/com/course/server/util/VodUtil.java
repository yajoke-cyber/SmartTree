...
//        request.setCoverURL("http://vod.aliyun.com/test_cover_url.jpg");
        request.setCateId(1000502369L);
        request.setTemplateGroupId("28608fc4af92fc43cdccced52674489c");
    ...
    public static void main(String[] argv) {
        //您的AccessKeyId
        String accessKeyId = "LTAI5tCPA2pJW8ZrjhTcKNXt";
        //您的AccessKeySecret
        String accessKeySecret = "cyRdjOA72GbeIlw0YcZtQMsUTKfKoP";
